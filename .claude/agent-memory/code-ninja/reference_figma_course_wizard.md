...
| `12539:31429` | LMS - 30 | **GenerationController** — generating interstitial ("Your course is being created…") |
| `12539:31764` / `12539:31869` / `12796:37264` / `12699:20343` | LMS - 32 / 86 / 118 / 117 | **GenerationController** review sub-phase (`courses/review/*`: "Review Course Content", notes/slides/sources) |
| `12539:32156` | LMS - 37 | **Step6QuizReview** ("Review Quiz Questions") |
| `12539:32277` | LMS - 33 | **Step7Assign** ("Assigning & Publish") — matches the implemented feature set |
