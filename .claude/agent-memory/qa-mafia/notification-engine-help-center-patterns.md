...
**The whole Settings page is gated on `organization.edit`, not just the Notifications tab.** `src/app/dashboard/(main)/settings/page.tsx` admits Owner, Admin and HR. Supervisor, Clinical Director, Finance and workers get "Page not found" and no sidebar link.
