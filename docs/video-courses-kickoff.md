...
- **Quiz authoring:** the system admin **uploads a quiz file (CSV/JSON)** with the video. Needs a defined schema + import/validation UI, mapping into the existing quiz/question model.
