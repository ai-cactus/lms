...
export default async function AssignCoursePage(props: PageProps) {
  ...
  const course = await prisma.course.findFirst({
    where: {
      id,
      OR: [
        // Global implies video — Theraptly uploads those, and every organisation
        // may assign one. A reading course is generated by a single organisation
        // from its own compliance material and is never assignable outside it, so
