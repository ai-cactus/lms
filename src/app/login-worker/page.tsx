...
import { authenticateWorker } from '@/app/actions/auth-worker';
...
function LoginForm() {
    ...
    const [state, dispatch, isPending] = useActionState(authenticateWorker, undefined);
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <div style={{ fontSize: '13px', color: '#B91C1C' }}>
                            Your account exists but is registered as an <strong>Admin</strong>.
                            Please use the <Link href="/login" style={{ textDecoration: 'underline', color: 'inherit' }}>Admin Login</Link> instead.
                        </div>
                    </div>
                </div>
            )}
