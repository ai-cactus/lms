        ...
        <div className={styles.formContent}>
          ...
          {!orgDetails ? (
            ...
            <div className={styles.card}>
              <div className={styles.cardHeader}>
                <div className={styles.orgIcon}>{orgDetails.name.charAt(0).toUpperCase()}</div>
                <div>
              ...
              <div className={styles.detailsGrid}>
                ...
                {orgDetails.phone && (
                  <div className={styles.detailItem}>
                    ...
                    <a href={`tel:${orgDetails.phone}`} className={styles.detailLink}>
                      {orgDetails.phone}
                    </a>
                  </div>
                )}
              ...
              <div className={styles.cardActions}>
                <Button variant="outline" onClick={handleDiscard} fullWidth disabled={loading}>
                  Discard
                </Button>
                <Button onClick={handleJoin} fullWidth loading={loading}>
                  Join Organization
                </Button>
              </div>
            </div>
          ...
          <div style={{ marginTop: '32px', textAlign: 'center' }}>
            ...
            <Button
              variant="ghost"
              size="sm"
              onClick={() => signOut({ callbackUrl: `${process.env.NEXT_PUBLIC_APP_URL}/signup` })}
              style={{
                color: '#4C6EF5',
                fontWeight: 500,
      ...
      <div className={styles.heroSection}>
        ...
        <div className={styles.heroOverlay}>
          <div className={styles.heroTextContent}>
            <h2 className={styles.heroTitle}>Welcome to the team</h2>
