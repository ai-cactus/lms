    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.intro}>
                ...
                <p><strong>Address:</strong> 431 Woodcrest Dr SE, Washington, DC 20032</p>
                <p><strong>Email:</strong> <a href="mailto:internovatechnologies@gmail.com" className="text-primary hover:underline">internovatechnologies@gmail.com</a></p>
            </div>

            <section className={styles.section}>
                <h2 className={styles.sectionTitle}>1. Agreement and Acceptance</h2>
                <p className={styles.text}>
                    These Terms of Service (“Terms”) govern access to and use of the Internova LMS platform (“Platform”) provided by Internova Technologies (“Company,” “we,” “us”).
                    If you access or use the Platform on behalf of an organization (“Customer”), you represent and warrant that you have authority to bind that organization.
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}>The Platform is a cloud-based learning management system that enables organizations to:</p>
                ...
                <p className={styles.text}>
                    The Platform is provided as software-as-a-service. Nothing in these Terms creates an obligation to deliver services beyond those expressly described in a written order or subscription agreement.
                </p>
            </section>
            ...
            <section className={styles.section}>
                <div className={styles.alert}>
                    ...
                    <h3 className={styles.subSectionTitle} style={{ color: '#991B1B' }}>3.1 No PHI Permitted</h3>
                    <p className={styles.alertText}>
                        ...
                        Customer shall not upload, transmit, store, or otherwise process PHI through the Platform.
                        <strong>This prohibition is material to this Agreement.</strong>
                    </p>

                    <h3 className={styles.subSectionTitle} style={{ color: '#991B1B' }}>3.2 No Business Associate Relationship</h3>
                    <p className={styles.alertText}>
                        Internova Technologies is not acting as a Business Associate under HIPAA in connection with the Platform. No Business Associate Agreement is offered or implied.
                    </p>

                    <h3 className={styles.subSectionTitle} style={{ color: '#991B1B' }}>3.3 Remedies for PHI Upload</h3>
                    ...
                    <ul className={styles.list} style={{ color: '#B91C1C' }}>
                        <li className={styles.listItem}>Company may immediately suspend access without notice.</li>
                        <li className={styles.listItem}>Company may permanently delete such data without liability.</li>
                        <li className={styles.listItem}>Customer shall bear sole responsibility for all regulatory, legal, and financial consequences.</li>
                        <li className={styles.listItem}>Customer shall defend, indemnify, and hold harmless Company from any claim, investigation, penalty, or damage arising from the upload of PHI.</li>
                    </ul>
                </div>
            </section>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}>Customer is responsible for all activity occurring under its accounts.</p>
            </section>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}>Customer retains ownership of content uploaded to the Platform.</p>
                <p className={styles.text}>Customer grants Company a limited, non-exclusive license to host and process such content solely to provide the services.</p>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}><strong>The Platform is provided “AS IS” and “AS AVAILABLE.”</strong></p>
                <p className={styles.text}>Company disclaims all warranties, express or implied, including:</p>
                <ul className={styles.list}>
                ...
                <p className={styles.text}>Customer is solely responsible for determining regulatory suitability.</p>
            </section>

            <section className={styles.section}>
                <h2 className={styles.sectionTitle}>8. Fees and Payment</h2>
                <p className={styles.text}>
                    Fees are due as specified in the applicable order. Failure to pay may result in suspension. All fees are non-refundable unless otherwise agreed in writing.
                </p>
            </section>
            ...
            <section className={styles.section}>
                ...
                <ul className={styles.list}>
                    ...
                    <li className={styles.listItem}>After that period, Company may permanently delete all data.</li>
                </ul>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}>To the maximum extent permitted by law, Company shall not be liable for:</p>
                <ul className={styles.list}>
                ...
                <p className={styles.text}>
                    <strong>Company’s total cumulative liability shall not exceed the total fees paid by Customer in the twelve (12) months preceding the claim.</strong>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}>Customer shall defend, indemnify, and hold harmless Company from all claims, liabilities, damages, costs, and expenses arising from:</p>
                <ul className={styles.list}>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}>
                    Each party agrees to protect the other’s non-public business information with reasonable care and not disclose it except as required by law.
                </p>
            </section>

            <section className={styles.section}>
                <h2 className={styles.sectionTitle}>13. Force Majeure</h2>
                <p className={styles.text}>Company shall not be liable for failure or delay resulting from causes beyond reasonable control, including:</p>
                <ul className={styles.list}>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}>
                    Customer may not assign these Terms without Company’s prior written consent. Company may assign these Terms in connection with merger, acquisition, or asset sale.
                </p>
            </section>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}>
                    ...
                    Any dispute shall be resolved exclusively in the state or federal courts located in Delaware. The parties waive any objection to venue.
                </p>
            </section>

            <section className={styles.section}>
                <h2 className={styles.sectionTitle}>16. Binding Arbitration; Class Action Waiver</h2>
                <p className={styles.text}>At Company’s election, any dispute may be resolved by binding arbitration under the rules of the American Arbitration Association.</p>
                ...
                <p className={styles.text}><strong>Each party waives the right to trial by jury.</strong></p>
            </section>
