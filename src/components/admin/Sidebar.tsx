                ...
                <div className="flex-1 overflow-y-auto py-6 px-3 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="space-y-1">
                            ...
                            {/* Nested items - Dashboard, Courses and Staff Details */}
                            {isTrainingCenterOpen && (
                                <div className="pl-4 space-y-1">
                                    <Link
                                        href="/admin/dashboard"
                                        className={`flex items-center px-3 h-14 text-base font-medium rounded-lg transition-colors ${pathname === '/admin/dashboard'
                                            ? 'text-black bg-[#EDEFF0]'
                                            : 'text-slate-600 hover:bg-white hover:text-slate-900'
                                            }`}
                                        onClick={() => onCloseMobileMenu()}
