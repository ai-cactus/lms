...
export default function ComingSoon({ title, description, returnUrl = '/dashboard' }: ComingSoonProps) {
    return (
        <div style={{
            display: 'flex',
            ...
            <h1 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '8px', color: '#2D3748' }}>{title}</h1>
