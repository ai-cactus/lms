...
export default function CourseSlide({
    ...
    return (
        <div className={`${styles.slideStage} ${styles.fadeEnter}`} ref={slideRef} tabIndex={-1} style={{ outline: 'none' }}>
            <button
            ...
            <div className={styles.slideCard}>
                ...
                <div className={styles.slideInner}>
                    <div className={styles.slideMeta}>
                        ...
                        <span className={styles.slideCounter}>{lesson.moduleIndex + 1} / {lesson.totalModules}</span>
                    </div>
