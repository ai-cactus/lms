        ...
        <div style={{
            ...
            <div style={{
                ...
                <p style={{ fontSize: '14px', color: '#4A5568', marginBottom: '20px', lineHeight: 1.5 }}>
                    This action will create a new retake attempt for <strong>{userName}</strong> on the course <strong>{courseName}</strong>. Their previous attempts will be preserved in the system but the course will be marked as in-progress again.
                </p>

                {error && (
                    <div style={{ padding: '12px', backgroundColor: '#FFF5F5', color: '#C53030', borderRadius: '8px', fontSize: '14px', marginBottom: '16px' }}>
                        {error}
                    </div>
                )}
