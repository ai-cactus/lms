...
export default function TimePicker({ value, onChange, placeholder = 'e.g. 1:00 PM' }: TimePickerProps) {
        ...
        <div className={styles.container}>
            <div className={`${styles.inputWrapper} ${isFocused ? styles.active : ''}`}>
                <input
                    ...
                    style={{ background: 'transparent', border: 'none', outline: 'none', width: '100%', color: 'inherit', fontSize: 'inherit' }}
