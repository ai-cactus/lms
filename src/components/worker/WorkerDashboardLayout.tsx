      ...
      <aside className={`${styles.sidebar} ${sidebarOpen ? styles.sidebarOpen : ''}`}>
        ...
        <nav className={styles.nav}>
          ...
          <div className={styles.navSection}>
            ...
            <Link
              href="/worker"
              className={`${styles.navItem} ${pathname === '/worker' ? styles.active : ''}`}
            >
              <svg
                width="20"
                height="20"
            ...
            <Link
              ...
              className={`${styles.navItem} ${pathname.startsWith('/worker/trainings') ? styles.active : ''}`}
            >
              <svg
                width="20"
                height="20"
            ...
            <Link
              ...
              className={`${styles.navItem} ${pathname.startsWith('/worker/certificates') ? styles.active : ''}`}
            >
              <svg
                width="20"
                height="20"
