 ...
 * fails when it does. It also makes correctness impossible to verify locally —
 * `courses/[id]/learn/route.ts` looks unguarded but authorises two layers down
 * inside getLearnPayload, which neither a reviewer nor a grep can tell apart from
 * a genuine hole.
 *
